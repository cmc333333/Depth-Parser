...
class LayersLinksInterpInternalTest(TestCase):
    ...
    def test_comment_whitepace(self):
        """Confirm that whitespace is not allowed between period-separated piece"""
        text = "comment 10(x)-3.\nii. Some new content"
        comments = list(comment.scanString(text))
    ...
    def test_comment_citations(self):
        ...
        self.assertEqual([(10, 25), (30, 48), (58, len(text)-1)], comment_citations(text))
